    ...
    <>
      ...
      <section className={style.containerNotFound}>
        <div className={style.notFound}>
          ...
          <img className={style.notFoundImg} src={notFoundPage} alt='not found page' />
          <h2 className={style.notFoundTitleInform}>Page not found</h2>

          <p className={style.notFoundMessage}>We`re sorry, the page you requesterd could not be found</p>
